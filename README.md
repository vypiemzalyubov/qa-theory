...
<div id="header" align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/1271/1271366.png" width="100"/>
</div>
...
- **Тестирование API**
  ...
  - [Как тестировать не-REST-бэкенд. Часть третья, gRPC](https://habr.com/ru/companies/qiwi/articles/753778/)
- **Тестирование UI**
...
- [Что такое веб-сокеты и как они вообще работают](https://ru.hexlet.io/blog/posts/chto-takoe-websocket-i-kak-oni-voobsche-rabotayut)
...
- [System Design 101](https://habr.com/ru/articles/770564/comments/)
- [Stateful и Stateless- архитектуры – объяснение для новичков](https://wiki.merionet.ru/articles/stateful-i-stateless-arxitektury-obieiasnenie-dlia-novickov)
...
- [Aleksei Koledachkin | AQA](https://www.youtube.com/@qa-proka4)
